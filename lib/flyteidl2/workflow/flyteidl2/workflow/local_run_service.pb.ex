defmodule Flyteidl2.Workflow.CreateLocalRunRequest.LabelsEntry do
  @moduledoc false

  use Protobuf,
    full_name: "flyteidl2.workflow.CreateLocalRunRequest.LabelsEntry",
    map: true,
...
defmodule Flyteidl2.Workflow.CreateLocalRunRequest do
  @moduledoc false

  use Protobuf,
    full_name: "flyteidl2.workflow.CreateLocalRunRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
  ...
  field :labels, 7,
    repeated: true,
    type: Flyteidl2.Workflow.CreateLocalRunRequest.LabelsEntry,
    map: true

  field :run_start_time, 8, type: Google.Protobuf.Timestamp, json_name: "runStartTime"
end

defmodule Flyteidl2.Workflow.LocalActionUpdate do
  @moduledoc false

  use Protobuf,
    full_name: "flyteidl2.workflow.LocalActionUpdate",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Flyteidl2.Workflow.ReportLocalActionsRequest do
  @moduledoc false

  use Protobuf,
    full_name: "flyteidl2.workflow.ReportLocalActionsRequest",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3

  field :run_id, 1, type: Flyteidl2.Common.RunIdentifier, json_name: "runId", deprecated: false
  field :updates, 2, repeated: true, type: Flyteidl2.Workflow.LocalActionUpdate, deprecated: false
end

defmodule Flyteidl2.Workflow.ReportLocalActionsResponse do
  @moduledoc false

  use Protobuf,
    full_name: "flyteidl2.workflow.ReportLocalActionsResponse",
    protoc_gen_elixir_version: "0.17.0",
    syntax: :proto3
...
defmodule Flyteidl2.Workflow.LocalRunService.Service do
  @moduledoc false

  use GRPC.Service,
    name: "flyteidl2.workflow.LocalRunService",
    protoc_gen_elixir_version: "0.17.0"

  rpc :CreateRun, Flyteidl2.Workflow.CreateLocalRunRequest, Flyteidl2.Workflow.CreateRunResponse

  rpc :ReportActions,
      Flyteidl2.Workflow.ReportLocalActionsRequest,
      Flyteidl2.Workflow.ReportLocalActionsResponse
...
defmodule Flyteidl2.Workflow.LocalRunService.Stub do
  @moduledoc false

  use GRPC.Stub, service: Flyteidl2.Workflow.LocalRunService.Service
end
